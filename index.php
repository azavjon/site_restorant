...
<div class=" header ">
    <div class="container ">
        <div class="header-line ">
            ...
            <div class="bton ">
                <a class="button " href="vendor/menu.php">ЗАКАЗ БЛЮДЫ</a>
            </div>
            ...
            <div id="menu " class="burger-slide disp ">
                ...
                <a class="nav-item block " href="vendor/menu.php">Меню</a>
        ...
        <div class="block-holder ">
            ...
            <div class="right ">
                <div class="right-button ">
                    <a href="vendor/menu.php" class="right-btn ">ЗАКАЗ БЛЮДЫ</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="dishes ">
    <div class="container ">
        ...
        <div class="foot ">
            <div class="foot-img ">
                <img src="img/pissa.png " alt=" ">
            </div>
            <div class="foot-items ">
                <div class="foot-item ">
                    <img src="img/5.png " alt=" " class="foots ">
                    <div class="foot-text ">
                        Гамбургер мини -------------- 22.с
                    </div>
                </div>
            ...
            <div class="form ">
                <fieldset>
                    ...
                    <form action=" ">
                        ...
                        <input type="email " placeholder="Логин " class="input ">
                        <br>

                        <input type="password " placeholder="Парол " class="input ">
                        <br>
                        <br>
